...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  var _currPageValue = 0.0; // to begin scaling.
  double _scaleFactor = 0.8;
  double _height = Dimensions.pageViewContainer;

  //to get the page value now.
  @override
  void iniState() {
    super.initState();
  ...
  //this tells the memory to dispose the pagecontroller whilem not in use.
  @override
  void dispose() {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        GetBuilder<PopularProductController>(builder: (popularProducts) {
          return SmoothPageIndicator(controller:  pageController, count:  popularProducts.popularProductList.isEmpty ? 1
